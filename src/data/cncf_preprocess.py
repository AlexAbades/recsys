...
class PreProcessDataNCFContextual:
    ...
    def _get_element_idx_given_min_interactions(
        self,
        data: DataFrame,
        filter_column: str,
        ratings_column: str,
    ...
    def _initialize_iterative_cleaning(
        ...
        data_iter = data.copy()
        while not is_stable:
            item_indx = self._get_element_idx_given_min_interactions(
                data_iter, item_column, interaction_column, min_interactions
            )
            data_clean_items = data_iter[~item_indx]
            user_indx = self._get_element_idx_given_min_interactions(
